...
const Main = () => {
  return (
    ...
    <div id='main' className='w-full lg:h-screen text-center bg-spooky'>
        <div id='main-2' className='container max-w-[1400px] w-full h-full max-auto p-2 flex justify-center items-center'>
            ...
            <div>
                ...
                <h1 className='py-4 text-white'>
                    Hi I am <span className='text-transparent bg-clip-text bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-600 text-center cursor-pointer'>Abdullah Ghaffar</span>
                 </h1>
